...
function startCardAnimations() {
    ...
    // Show header bear
    const headerBear = document.querySelector('.header-bear');
    headerBear.classList.add('show');
    ...
    // Show love symbol
    const loveSymbol = document.querySelector('.love-symbol');
    loveSymbol.classList.add('show');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Add click effect to love symbol
    const loveSymbol = document.querySelector('.love-symbol');
    loveSymbol.addEventListener('click', function() {
        this.style.animation = 'loveBeat 0.5s ease-in-out';
        setTimeout(() => {
            this.style.animation = 'loveBeat 2s ease-in-out infinite';
        }, 500);
    });
});
...
window.addEventListener('load', function() {
    console.log('¡Bienvenidos al Baby Shower - Versión 2! 🐻👶💕');
});